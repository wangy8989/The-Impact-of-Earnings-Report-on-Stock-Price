...
bool Group::Computing(const Share& SPY) {
	...
	// i is stocks multimap
	for (auto i = stocks.begin(); i != stocks.end(); ++i) {

		// slice SPY with corresponding start and end date
